		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "WebIdeFS - Demo",
									"targetURL": "#WebIdeFSDemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"WebIdeFSDemo-display": {
								"semanticObject": "WebIdeFSDemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sai.moola.FruitStore",
									"url": sap.ui.require.toUrl("sai/moola/FruitStore")
								}
							}
						}
					}
